        ...
        <View style={styles.section}>
          ...
          <View style={styles.buttonStack}>
            <View style={{ flexDirection: 'row', gap: 8 }}>
              <Pressable style={[styles.button, { flex: 1, backgroundColor: colors.primary }]} onPress={() => {}} android_ripple={{ color: colors.foreground, radius: 8 }}>
                <Text style={[styles.buttonText, { color: colors.textColor, textTransform: 'uppercase', letterSpacing: 0.5 }]}>Primary</Text>
              </Pressable>
              <Pressable
                style={[
                  styles.button,
                  { flex: 1, backgroundColor: 'transparent', borderWidth: 1, borderColor: colors.primary },
                ]}
                onPress={() => {}}
                android_ripple={{ color: colors.primary, radius: 8 }}
              >
                <Text style={[styles.buttonText, { color: colors.primary, textTransform: 'uppercase', letterSpacing: 0.5 }]}>Secondary</Text>
              </Pressable>
            </View>
            <Pressable
              style={[
            ...
            >
              <Text style={[styles.buttonText, { color: colors.border, textTransform: 'uppercase', letterSpacing: 0.5 }]}>Ghost</Text>
            </Pressable>
            <View style={{ flexDirection: 'row', gap: 8 }}>
              <Pressable
                style={[
                  styles.button,
                  { flex: 1, backgroundColor: hexToRgba(colors.error, 0.2), borderWidth: 1, borderColor: colors.error },
                ]}
                onPress={() => {}}
                android_ripple={{ color: colors.error, radius: 8 }}
              >
                <Text style={[styles.buttonText, { color: colors.error, textTransform: 'uppercase', letterSpacing: 0.5, fontWeight: '700' }]}>Destructive</Text>
              </Pressable>
              <Pressable
                style={[
                  styles.button,
                  { flex: 1, backgroundColor: hexToRgba(colors.success, 0.2), borderWidth: 1, borderColor: colors.success },
                ]}
                onPress={() => {}}
                android_ripple={{ color: colors.success, radius: 8 }}
              >
                <Text style={[styles.buttonText, { color: colors.success, textTransform: 'uppercase', letterSpacing: 0.5 }]}>Confirm</Text>
              </Pressable>
            </View>
            <LinearGradient
              colors={[colors.secondary, colors.secondaryGradient]}
              ...
              style={styles.button}
            >
              <Text style={[styles.buttonText, { color: colors.textColor, textTransform: 'uppercase', letterSpacing: 0.5 }]}>Gradient</Text>
            </LinearGradient>
          </View>
        </View>
